const CACHE_NAME='ss-journal-v13';
const APP_SHELL=['./','./index.html','./styles.css?v=13','./app.js?v=13','./ui-enhance.js?v=13','./ux.js?v=13','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];

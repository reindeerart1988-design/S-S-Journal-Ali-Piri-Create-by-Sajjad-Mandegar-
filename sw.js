const CACHE_NAME='ss-journal-v22';
const APP_SHELL=['./','./index.html','./styles.css?v=22','./app.js?v=22','./ui-enhance.js?v=22','./ux.js?v=22','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];

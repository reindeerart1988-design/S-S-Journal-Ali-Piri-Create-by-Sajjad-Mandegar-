const CACHE_NAME='ss-journal-v24';
const APP_SHELL=['./','./index.html','./styles.css?v=24','./app.js?v=24','./ui-enhance.js?v=24','./ux.js?v=24','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];

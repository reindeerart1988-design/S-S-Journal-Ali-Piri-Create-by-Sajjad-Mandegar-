const CACHE_NAME='ss-journal-v23';
const APP_SHELL=['./','./index.html','./styles.css?v=23','./app.js?v=23','./ui-enhance.js?v=23','./ux.js?v=23','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];

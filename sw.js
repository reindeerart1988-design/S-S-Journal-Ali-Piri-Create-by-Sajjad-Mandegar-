const CACHE_NAME='ss-journal-v25';
const APP_SHELL=['./','./index.html','./styles.css?v=25','./app.js?v=25','./ui-enhance.js?v=25','./ux.js?v=25','./subscription.js?v=25','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];

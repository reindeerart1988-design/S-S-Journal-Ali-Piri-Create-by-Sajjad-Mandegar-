const CACHE_NAME='ss-journal-v30';
const APP_SHELL=['./','./index.html','./styles.css?v=30','./app.js?v=30','./ui-enhance.js?v=30','./ux.js?v=30','./subscription.js?v=30','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];

const CACHE_NAME='ss-journal-v27';
const APP_SHELL=['./','./index.html','./styles.css?v=27','./app.js?v=27','./ui-enhance.js?v=27','./ux.js?v=27','./subscription.js?v=27','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];

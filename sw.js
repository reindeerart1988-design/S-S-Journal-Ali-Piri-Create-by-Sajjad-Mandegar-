const CACHE_NAME='ss-journal-v26';
const APP_SHELL=['./','./index.html','./styles.css?v=26','./app.js?v=26','./ui-enhance.js?v=26','./ux.js?v=26','./subscription.js?v=26','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];

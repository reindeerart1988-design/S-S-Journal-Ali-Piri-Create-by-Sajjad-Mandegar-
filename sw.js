const CACHE_NAME='ss-journal-v15';
const APP_SHELL=['./','./index.html','./styles.css?v=15','./app.js?v=15','./ui-enhance.js?v=15','./ux.js?v=15','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];

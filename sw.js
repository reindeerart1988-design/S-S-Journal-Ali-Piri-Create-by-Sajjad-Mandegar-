const CACHE_NAME='ss-journal-v20';
const APP_SHELL=['./','./index.html','./styles.css?v=20','./app.js?v=20','./ui-enhance.js?v=20','./ux.js?v=20','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];

const CACHE_NAME='ss-journal-v16';
const APP_SHELL=['./','./index.html','./styles.css?v=16','./app.js?v=16','./ui-enhance.js?v=16','./ux.js?v=16','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];

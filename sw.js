const CACHE_NAME='ss-journal-v19';
const APP_SHELL=['./','./index.html','./styles.css?v=19','./app.js?v=19','./ui-enhance.js?v=19','./ux.js?v=19','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
